  ...
  const questions = [
    {
      ...
      options: ["Fortnite", "Clash Royale", "Genshin Impact", "Call of Duty Mobile", "Diğer"],
      type: "select",
    ...
    },
    {
      ...
      options: ["Knight Online", "PUBG Mobile", "League of Legends", "Metin2", "Oyun 5", "Mobile Legends", "Valorant", "Clash of Clans", "Rise Online ", "Black Desert"],
      type: "select",
      state: selectedGame,
